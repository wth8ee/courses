...
ReactDOM.render(<App />, document.getElementById('root'));`;
  ...
  const test = () => {
    ...
    return root && root.innerHTML === "<h1>Привет, мир!</h1>";
  };
  ...
  return (
    <LessonLayout
        ...
        <>
          <p className="mb-5 text-adpt">
            **React** — это библиотека для создания пользовательских
            интерфейсов, разработанная компанией Facebook. Он позволяет строить
            интерфейсы с использованием компонентов, что делает код более
            модульным и удобным для повторного использования.
          </p>
      ...
      task={
        <>
          <p className="mb-2">
            Создайте компонент, который отображает следующее сообщение:
          </p>
          <ul className="list-disc ml-5 mb-5">
            <li>Приветствие "Привет, мир!"</li>
            <li>
              Используйте функциональный компонент и рендеринг через{" "}

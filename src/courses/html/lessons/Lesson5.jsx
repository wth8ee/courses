    ...
    <LessonLayout
      ...
      left={
        <>
          ...
          <p>
            <span className="hl">
              Маркированный список (<code>&lt;ul&gt;</code>)
            </span>{" "}
            — это список, в котором каждый пункт отображается с маркером
            (точкой, кружочком и т. д.). Каждый элемент списка располагается
            внутри тега <code>&lt;li&gt;</code>.
          </p>

          <p>
            <span className="hl">
              Нумерованный список (<code>&lt;ol&gt;</code>)
            </span>{" "}
            — используется, когда порядок элементов имеет значение. Список
            нумеруется автоматически.
          </p>

          <p>
            <span className="hl">Вложенные списки</span> — это списки, которые
            можно встраивать в другие списки, создавая многоуровневую структуру.
            Вложенный список может быть как маркированным, так и нумерованным.
          </p>

          <p>Пример использования различных типов списков:</p>
